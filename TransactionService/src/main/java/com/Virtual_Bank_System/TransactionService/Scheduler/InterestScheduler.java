...
//    if (systemAccount == null) throw new RuntimeException("System account not found");
//
//    List<Account> savingsAccounts =
//        accountRepo.findAllByAccountTypeAndActiveTrue(AccountType.SAVINGS, AccountStatus.ACTIVE);
//
...
//      try {
//        boolean result =
//            performTransfer(systemAccount.getAccountID(), userAccount.getAccountID(), interest);
//
//        if (result) {
...
//    String transferUrl = "http://ACCOUNT-SERVICE/api/accounts/transfer"; // Change as per your
// route
//
//    TransferInitiationDTO request =
//        new TransferInitiationDTO(UUID.randomUUID(), fromId, toId, amount, "Interest");
//
